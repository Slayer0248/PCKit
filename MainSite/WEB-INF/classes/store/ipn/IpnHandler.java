...
public class IpnHandler
{
    ...
    public IpnInfo handleIpn (HttpServletRequest request) throws IpnException {
        ...
        try
        {
            ...
            //5. Capture Paypal IPN information
            //String values = request.getParameter("custom").split(":");
            //int userId = Integer.parseInt(values[0]);
            int orderId = Integer.parseInt(request.getParameter("custom"));
            ipnInfo.setOrderId(orderId);
            //ipnInfo.setUserId(userId);
